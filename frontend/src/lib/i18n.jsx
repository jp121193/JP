...
const dict = {
  en: {
    ...
    "pending.pay.eyebrow": "Payment",
    "pending.pay.title": "Pay ₹500 to activate",
    "pending.pay.copy": "Scan the QR with any UPI app (GPay, PhonePe, Paytm, BHIM). Once we see the payment in the bank, we approve your account manually.",
    "pending.pay.upi": "UPI ID",
    "pending.pay.amount": "Amount",
    "pending.pay.amount.value": "₹500",
    "pending.pay.scan": "Scan to pay with any UPI app",
    "pending.help.title": "Need help? Call us",
    "pending.help.copy": "Tap the number to call directly.",
  ...
  hi: {
    ...
    "pending.pay.eyebrow": "भुगतान",
    "pending.pay.title": "एक्टिवेशन के लिए ₹500 का भुगतान करें",
    "pending.pay.copy": "किसी भी UPI ऐप (GPay, PhonePe, Paytm, BHIM) से QR स्कैन करें। बैंक में भुगतान दिखने पर, हम आपका खाता मैन्युअली अप्रूव कर देंगे।",
    "pending.pay.upi": "UPI ID",
    "pending.pay.amount": "राशि",
    "pending.pay.amount.value": "₹500",
    "pending.pay.scan": "किसी भी UPI ऐप से भुगतान के लिए स्कैन करें",
    "pending.help.title": "मदद चाहिए? कॉल करें",
    "pending.help.copy": "सीधे कॉल करने के लिए नंबर पर टैप करें।",
